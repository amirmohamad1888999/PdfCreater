...
const getFullURL = async (endpoint) => {
  ...
  return `${baseURL}/OrderApi/MerchantApplication/MerchantDeliveryTypes${endpoint}`;
};
...
export const GetAll = async () => makeRequest("get", "/GetAll", null, null);

export const Add = async (body) => makeRequest("post", "/Add", body);

export const Remove = async (id) => makeRequest("get", "/Remove", null, { id });
