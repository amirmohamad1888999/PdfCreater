...
const getFullURL = async (endpoint) => {
  ...
  return `${baseURL}/ProductApi/merchantApplication/ProductGroup${endpoint}`;
};
...
export const ProductGroup = async (body) => {
  return makeRequest("post", "/GetAll", body, {pageSize:0 , pageNumber:0});
};
