...
const getFullURL = async (endpoint) => {
  ...
  return `${baseURL}/OrderApi/MerchantApplication/Delivery${endpoint}`;
};
...
export const DeliveryEntry = async (body) => {
  return makeRequest("post", "/Entry", body);
};

export const UploadFile = async (body) => makeRequest("post", "/UploadFile", body,null);

export const DeleteFile = async (id) => makeRequest("get", "/DeleteFile", null , {id});